...
There are still many components missing, but this project is on a strong trajectory toward becoming an actually useful server engine.
## Purpose

The project aims to provide a cross-platform, high-performance, efficient server engine. Instead of using reflection, it makes use of Roslyn Source Generators to automate packet registration at compile time, ensuring the networking layer is as fast as possible.
