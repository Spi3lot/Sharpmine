    ...
    ILogger<ServerService> logger) : BackgroundService
{
    ...
    // TODO: Read favicon from server-icon.png
    public ServerStatus Status { get; } = new(
        Version: new StatusVersion(ServerConstants.VersionName, ServerConstants.VersionProtocol),
        Description: new StatusDescription(properties.Motd),
